<?php
	...
	function artise_submit_email_contents( $file ){
		...
		?>
			...
			<table width="100%" style="font-size=18px; font-family: Arial, Helvetica, sans-serif; font-weight: 100">
			    <tr>
			        <td style="text-align:center">
			            <img width="30%" src="http://cementtileus.com/index/wp-content/uploads/2016/01/Lili_Final_Logo-2-1-300x133.png" />
			            <br>
			            <hr>
			        </td>
			    </tr>
