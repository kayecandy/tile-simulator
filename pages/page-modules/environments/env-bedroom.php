...
<div id="bedroom-simulator" class="env-container" data-env="bedroom">
    ...
    <canvas id="bedroom-floor-container-1" class="floor-container bg-container three-bg-container small"
        data-part="floor-small" data-xRepeat="40" data-yRepeat="15" data-width="500" data-height="150"
        data-position="-2,-40,-1.5" data-rotation="-1.61,0,0" data-zcamera="70"
        data-borders="bedroom-border-1,bedroom-border-2"></canvas>
    ...
    <canvas id="bedroom-floor-container-2" class="floor-container bg-container three-bg-container big"
        data-part="floor-big" data-xRepeat="25" data-yRepeat="12" data-width="500" data-height="150"
        data-position="8,-40,0" data-rotation="-1.61,0,0" data-zcamera="70"
        data-borders="bedroom-border-3,bedroom-border-4"></canvas>
